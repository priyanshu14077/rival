  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2 relative z-10">
        <h1 className="text-3xl font-heading font-bold tracking-tighter mix-blend-difference text-white">ACCESS PORTAL</h1>
        <p className="text-muted-foreground text-sm font-mono">Execute login sequence</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-2">
          ...
          <input
            {...register("email")}
            type="email"
            placeholder="sys.admin@rival.net"
        ...
        <div className="pt-4">
           ...
           <button type="submit" disabled={mutation.isPending} className="w-full relative group">
              ...
              >
                {mutation.isPending ? "AUTHENTICATING..." : "INITIALIZE SESSION"}
              </StarBorder>
           </button>
        </div>
      </form>
